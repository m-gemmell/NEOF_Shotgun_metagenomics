...
<center>
![](/images/yarn_binning.png){style="width:400px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
- __Depth__: Contigs with similar depth are more likely to be from the same genome
