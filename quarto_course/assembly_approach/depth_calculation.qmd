...
<center>
![](/images/submarine.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## Alignment
<center>
![](/images/dna_alignment.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## SAM to sorted BAM
<center>
![](/images/sort.png){style="width:150px; background: white; border-radius:5px"}
</center>
...
## Summarise depths
<center>
![](/images/depth.png){style="width:150px; background: white; border-radius:5px"}
</center>
...
## View depths
<center>
![](/images/periscope.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## Summarise with R
<center>
![](/images/R.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>

For tutorial purposes we will have a better look at the depth by summarising the contig depths with `R`.
