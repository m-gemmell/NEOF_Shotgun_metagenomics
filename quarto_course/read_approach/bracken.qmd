...
# Bracken {#bracken}
<center>
![](/images/bracken.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## Extracting output
<center>
![](/images/exctractor.png){style="width:100px; background:white;border-radius:5px; border: white 5px solid"}
</center>
