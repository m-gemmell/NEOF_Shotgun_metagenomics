...
<center>
![](/images/k_w_venn.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## Combining data
<center>
![](/images/merge.png){style="width:100px; background:white; border-radius:5px"}
</center>
...
<center>
![](/images/split.png){style="width:100px; background:white; border-radius:5px"}
</center>
...
-   `diet_unstratified.tsv`: Table containing the total abundance values for the pathways
    - Does not contain any species stratification information.
-   `diet_stratified.tsv`: Table containing the species stratification abundance values for the pathways
    - Does not contain the total abundance information.
...
<center>
![](/images/normalisation.png){style="width:100px; background:white; border-radius:5px"}
</center>
