...
<center>
![](/images/bowtie2.png){style="width:200px; background: white; border-radius:5px"}
</center>
...
## Index reference
<center>
![](/images/index.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## Alignment
<center>
![](/images/alignment.png){style="width:200px; background: white; border-radius:5px; border: white 5px solid"}
</center>
...
#### Parameters {-}
<center>
![](/images/parameter_black.png){style="width:100px; background: white; border-radius:5px; border:white 5px solid"}
</center>
...
<center>
![](/images/exctractor.png){style="width:150px; border-radius:5px; background: white"}
</center>
...
#### Parameters {-}
<center>
![](/images/parameter_green.png){style="width:100px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
- __`-f`__: Output reads that only include the SAM flag
  ...
  - The following link is very useful to create a SAM flag you may need: [https://broadinstitute.github.io/picard/explain-flags.html](https://broadinstitute.github.io/picard/explain-flags.html)
...
## Re-pair
<center>
![](/images/repair.png){style="width:300px; background:white; border-radius:5px"}
</center>
...
<center>
![](/images/sum_blue.png){style="width:100px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
The assembly we used was: [GRCh38](https://ftp.ncbi.nlm.nih.gov/refseq/H_sapiens/annotation/GRCh38_latest/refseq_identifiers/GRCh38_latest_genomic.fna.gz)

## Next section
<center>
![](/images/read.png){style="width:150px; background:white; border-radius:5px"}
</center>

The next section is the [Read approach section](/read_approach/read_approach.qmd)