...
<center>
![](/images/quality_trimming_and_filtering.png){style="width:300px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
<center>
![](/images/hedge_trimming.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## Rename the files
<center>
![](/images/rename.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
<center>
![](/images/magnify_glass_good.png){style="width:150px; background: white; border-radius:5px; border: white solid 5px"}
</center>
