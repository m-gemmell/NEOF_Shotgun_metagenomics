...
We can generate some metrics based on the assembly with `QUAST`,  but first we will change directory to `6-Assembly` and create a directory for the `QUAST` output.
