...
#### Add quality to checkm results file {-}

Now we can combine the files "MAGS_checkm.csv" and "MAGS_quality.csv" with the `paste` command. The `-d ","` options indicates the merged files will be separated by commas (`,`), matching the column separation in "MAGS_checkm.csv".
