...
<!--chapter:end:20-Stitching_reads.Rmd-->
...
We can see the values of the `contigLen` and `totalAvgDepth` are very low. However, this is most likely due to a bunch of short and low coverage contigs which will be ignored by `MetaBAT2`. 
...
<!--chapter:end:23-Bin_quality.Rmd-->
...
<!--chapter:end:24-Assembly_functional_annotation.Rmd-->
