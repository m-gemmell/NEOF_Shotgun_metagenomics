...
<center>
![](figures/16s_vs_shotgun.png){style="width:150px; border-radius:15px; border:5px solid #333333; background-color:white"}
</center>
...
### Content
<center>
![](figures/sections.png){style="width:100px; border-radius:5px; border:5px solid #333333; background-color:white"}
</center>
...
__To open a new terminal window__, right click on the main screen, choose `Terminal`
...
<center>![](figures/paired_reads.png){style="border-radius: 15px; width: 300px; border: 5px solid #333333"}</center>
...
- `-d` : Specifies the `Kraken2` database that was used for taxonomic classification. In this case bracken requires the variable `$KRAKEN2_DB_PATH` so the option is provided the full path to the kraken database. For clarity try the command `ls $KRAKEN2_DB_PATH/minikraken2_v1_8GB`. 
...
```{r, echo = FALSE}
opts_p <- c(answer="__0.0014961642897455565__","__3.0266165524513937__","__3.314396201978439__")
```
5. What is the LEfSe p-value for __Campylobactercoli__? `r longmcq(opts_p)`

```{r, echo = FALSE}
opts_p <- c("__0.0014961642897455565__",answer="__3.0266165524513937__","__3.314396201978439__")
```
6. What is the Log of highest class average for __Streptococcussuis__? `r longmcq(opts_p)`

```{r, echo = FALSE}
opts_p <- c("__0.0014961642897455565__","__3.0266165524513937__",answer="__3.314396201978439__")
```
...
<center>![](figures/humann3_workflow.png){style="width: 750px; border-radius: 15px; border: 5px solid #333333"}</center>
...
<center>
![](figures/humann_heatmap.png){style="border-radius: 15px; width: 750px; border: 5px solid #333333"}
</center>
...
__Task__: Go back to your `shotgun_meta` terminal (or create a new one and use `. useshotgun`). Then change directory to `4-FunctionalProfiling`)
...
<center>
![](figures/reads_aligned.png){style="border-radius: 10px; width: 400px; border: 5px solid #333333"}
</center>

2.  All k-mers are linked to other k-mers which match with a k-1 length overlap (i.e. that overlap by all but one base):

<center>
![](figures/graph_simple.png){style="border-radius: 10px; width: 800px; border: 5px solid #333333"}
</center>

3.  Paths are routed through the graph and longer contigs are generated:

<center>
![](figures/graph_complex.png){style="border-radius: 10px; width: 800px; border: 5px solid #333333"}
</center>
...
<center>
![](figures/merging_paired_reads.png){style="width: 400px; border-radius: 15px; border: 5px solid #333333; background-color: white"}
</center>
...
# Megahit Assembly
<center>
![](figures/puzzle.png){style="width: 200px; border-radius: 15px; border: 5px solid #333333; background-color: white"}
</center>
...
<center>
![](figures/n50_n90.png){style="border-radius: 15px; width: 400px; border: 5px solid #333333"}
</center>
...
## Bakta
<center>![](figures/bakta_logo.png){style="border-radius: 15px; width: 250px; border: 5px solid #333333"}</center>
...
# Manuals
```{r, fig.align = 'center',out.width= '15opx', echo=FALSE }
