...
One neural network is used to improve the completeness estimation and one neural network is used to improve the contamination estimation.

The neural network implementations are from `sklearn`.
If you are interested in how the machine learning step work please see the CoCoPyE publication: https://academic.oup.com/gigascience/article/doi/10.1093/gigascience/giae079/7841111
...
## Bin quality summary
<center>
![](figures/sum_black.png){style="width:100px; background: white ; border-radius:5px; border: 5px white solid"}
</center>
