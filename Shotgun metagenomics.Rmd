...
<center>
![](figures/humann3_workflow.png){style="width: 750px; border-radius: 15px; border: 5px solid #333333"}
</center>
...
<center>![](figures/humann_heatmap.png){style="border-radius: 15px; width: 750px; border: 5px solid #333333"}</center>
...
__Note:__ Due to the assembly process you values may be slightly different (< 1%). Please choose the closest value
