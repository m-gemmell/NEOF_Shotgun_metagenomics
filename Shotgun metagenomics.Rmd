...
<center>![](figures/reads_aligned.png){style="border-radius: 10px; width: 400px; border: 5px solid #333333"}</center>

2.  All k-mers are linked to other k-mers which match with a k-1 length overlap (i.e. that overlap by all but one base):

<center>![](figures/graph_simple.png){style="border-radius: 10px; width: 800px; border: 5px solid #333333"}</center>

3.  Paths are routed through the graph and longer contigs are generated:

<center>![](figures/graph_complex.png){style="border-radius: 10px; width: 800px; border: 5px solid #333333"}</center>
...
<center>![](figures/merging_paired_reads.png){style="width: 400px; border-radius: 15px; border: 5px solid #333333; background-color: white"}</center>
...
<center>![](figures/n50_n90.png){style="border-radius: 15px; width: 400px; border: 5px solid #333333"}</center>
