...
```{r, echo = FALSE}
opts_p <- c("__Ruminococcuschampanellensis__",answer="__Alistipesshahii__","__Methanosphaerastadtmanae__")
```
1. Which species biomarker causes the biggest effect in the __W__ class? `r longmcq(opts_p)`

```{r, echo = FALSE}
opts_p <- c("__Ruminococcuschampanellensis__","__Alistipesshahii__",answer="__Methanosphaerastadtmanae__")
```
2. Which species biomarker causes the biggest effect in the __K__ class? `r longmcq(opts_p)`

```{r, echo = FALSE}
opts_p <- c(answer="__Ruminococcuschampanellensis__","__Alistipesshahii__","__Methanosphaerastadtmanae__")
```
...
```{r, echo = FALSE}
opts_p <- c(answer="__0.0022136919545913936__","__3.0271864317141715__","__3.3224493820428482__")
```
5. What is the LEfSe p-value for __Campylobactercoli__? `r longmcq(opts_p)`

```{r, echo = FALSE}
opts_p <- c("__0.0022136919545913936__",answer="__3.0271864317141715__","__3.3224493820428482__")
```
6. What is the Log of highest class average for __Streptococcussuis__? `r longmcq(opts_p)`

```{r, echo = FALSE}
opts_p <- c("__0.0022136919545913936__","__3.0271864317141715__",answer="__3.3224493820428482__")
```
