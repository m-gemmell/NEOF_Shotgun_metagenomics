...
-   **`--threads`**: Number of CPUs the process will use.
...
5.  **LCA mapping:** A space-delimited list indicating the LCA mapping of each k-mer in the sequence(s). For example, "562:13 561:4 A:31 0:1 562:3" would indicate that:
