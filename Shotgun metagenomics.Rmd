...
<center>![](figures/paired_reads.png){style="border-radius: 15px; width: 40%"}</center>
...
<center>![](figures/humann3_workflow.png){style="border-radius: 15px; width: 75%"}</center>
...
<center>![](figures/humann_heatmap.png){style="border-radius: 15px; width: 75%"}</center>
...
<center>![](figures/n50_n90.png){style="border-radius: 15px; width: 40%"}</center>
...
### CheckM: Mamba
<center>![](figures/mamba_logo.png){style="width: 20%"}</center>
...
## Bakta
<center>![](figures/bakta_logo.png){style="border-radius: 15px; width: 25%"}</center>
