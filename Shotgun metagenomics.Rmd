...
### Bracken: merging and extracting output
...
- `-x` : Suffix/extension of bin files. Other file are ignored in the specified bin directory.
   - `fa` is used as `MetaBAT2` produced fasta files ending in `.fa`.
...
<!--chapter:end:12-Gene_prediction.Rmd-->
...
<!--chapter:end:13-Functional_annotation.Rmd-->
...
<!--chapter:end:14-Co_assembly.Rmd-->
...
<!--chapter:end:15-Comparative_analysis.Rmd-->
...
MetaPhlAn 2: https://huttenhower.sph.harvard.edu/metaphlan2/
