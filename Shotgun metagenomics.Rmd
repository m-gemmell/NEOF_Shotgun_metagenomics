...
```{bash eval=FALSE}
cp /pub39/tea/nsc006/NEOF/Shotgun_metagenomics/humann2/demo.fq.gz .
```
...
```{bash eval=FALSE}
cp /pub39/tea/nsc006/NEOF/Shotgun_metagenomics/diet.metadata.tsv .
```
...
- Manual: https://github.com/biobakery/biobakery/wiki/humann3
...
Now you can carry on with the online tutorial if you wish using your `MetaWRAP` terminal. Instructions on activating the environment can be found [here](#prokka_conda).
...
### HUMAnN comparison: combining data
```{r, fig.align = 'center',out.width= '10%', echo=FALSE }
knitr::include_graphics(path = "figures/merge.png", auto_pdf = TRUE)
``` 
...
### HUMAnN comparison: renormalising data
```{r, fig.align = 'center',out.width= '10%', echo=FALSE }
knitr::include_graphics(path = "figures/normalisation.png", auto_pdf = TRUE)
``` 
