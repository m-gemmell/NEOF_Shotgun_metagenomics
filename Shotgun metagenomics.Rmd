...
column_1 <- c(
 ...
 '[![](figures/jigsaw.png){style="height:150px; border-radius:15px; border:5px solid #333333; background:white"}](#metagenomeassembly)',
...
### Content
<center>
![](figures/sections.png){style="width:100px; border-radius:5px; background-color:white"}
</center>
